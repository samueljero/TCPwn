...
#Clients
background_client_cmd = "curl -o /dev/null -m 120 http://10.0.3.4/smallfile"
main_client_cmd = "curl -o /dev/null -m 120 http://10.0.3.3/smallfile"
...
vm_has_ssh = [True,True,False,True,True]
vm_user = "root"
vm_ip_base = "10.0.1.{0}"
vm_ram = "2048"
vm_cores = "2"

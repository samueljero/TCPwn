...
background_server_config = "echo reno > /proc/sys/net/ipv4/tcp_congestion_control"
target_server_ip = "10.0.3.3"
background_server_ip = "10.0.3.4"

#Clients
background_client_cmd = "curl -o /dev/null -m {tm} http://10.0.3.4/smallfile"
main_client_cmd = "curl -o /dev/null -m {tm} http://10.0.3.3/smallfile"
